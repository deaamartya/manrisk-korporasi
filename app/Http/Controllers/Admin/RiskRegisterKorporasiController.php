...
class RiskRegisterKorporasiController extends Controller
{
    public function index()
    {
        ...
        // dd($jml_risk);
        return view('admin.risk-register-korporasi', compact('headers', 'jml_risk'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.risk-register-korporasi.index')->with(['success-swal' => 'Risk Header KORPORASI berhasil disimpan!']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.risk-register-korporasi.index')->with(['success-swal' => 'Risk Header KORPORASI berhasil diubah!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.risk-register-korporasi.index')->with(['success-swal' => 'Risk Header KORPORASI berhasil dihapus!']);
    }
    ...
    public function show($id)
    {
        ...
        $s_risiko = SRisiko::join('risk_detail', 's_risiko.id_s_risiko', 'risk_detail.id_s_risiko')
                ->where('s_risiko.tahun', '=', $headers->tahun)
                ->where('risk_detail.status_korporasi', '=', 0)
                ->orderBy('s_risiko.id_s_risiko')
                ->limit(1)->first();

        $target = RiskHeaderKorporasi::where('id_riskh', '=', $id)->pluck('target')->first();
        $sasaran = explode("\r\n", $target);
        ...
        return view('admin.detail-risk-register-korporasi', compact('headers', 'detail_risk', 'detail_risk_korporasi','pilihan_s_risiko', 'nilai_l', 'nilai_c', 'sasaran'));
    }
    ...
    public function storeDetail(Request $request)
    {
        ...
        return Redirect::back()->with(['success-swal' => 'Risk KORPORASI berhasil dibuat!']);
    }
    ...
    public function uploadLampiran(Request $request) {
        ...
        return redirect()->route('admin.risk-register-korporasi.show', $id)->with(['success-swal' => 'Lampiran berhasil diupload!']);
    }


    public function print($id) {
        $header = RiskHeaderKorporasi::where('id_riskh', '=', $id)->first();
        $document_type = 'risk_register_korporasi_admin';
        ...
        $pdf = PDF::loadView('admin.pdf-risk-register-korporasi', compact('header', 'detail_risk', 'qrcode'))->setPaper('a4', 'landscape');
