...
class PetaRisikoController extends Controller
{
    public function show($id, Request $req) {
        ...
        return view('risk-officer.peta-risiko', compact("s_risiko", "data_low", "data_med", "data_high", "data_extreme", 'r_total', 'r_tertinggi', 'tahun_req', 'divisi', "data_low_mitigasi", "data_med_mitigasi", "data_high_mitigasi", "data_extreme_mitigasi"));
    }
}
