...
class RiskRegisterKorporasiController extends Controller
{
    public function index()
    {
        ...
        // dd($jml_risk);
        return view('risk-officer.risk-register-korporasi', compact('headers', 'jml_risk'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('risk-officer.risk-register-korporasi.index')->with(['success-swal' => 'Risk Header KORPORASI berhasil disimpan!']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('risk-officer.risk-register-korporasi.index')->with(['success-swal' => 'Risk Header KORPORASI berhasil diubah!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('risk-officer.risk-register-korporasi.index')->with(['success-swal' => 'Risk Header KORPORASI berhasil dihapus!']);
    }
    ...
    public function show($id)
    {
        ...
        $detail_risk_korporasi = RiskDetail::selectRaw('*,avg(pi.nilai_L) as avg_nilai_l, avg(pi.nilai_C) as avg_nilai_c')
                ...
                ->groupBy('id_riskd')
                ->get();
        return view('risk-officer.detail-risk-register-korporasi', compact('headers', 'detail_risk', 'detail_risk_korporasi'));
    }
    ...
    public function uploadLampiran(Request $request) {
        ...
        return redirect()->route('risk-officer.risk-register-korporasi.show', $id)->with(['success-swal' => 'Lampiran berhasil diupload!']);
    }
    ...
    public function print($id) {
        ...
        $pdf = PDF::loadView('risk-officer.pdf-risk-register-korporasi', compact('header', 'detail_risk', 'qrcode'))->setPaper('a4', 'landscape');
