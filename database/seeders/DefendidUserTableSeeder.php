    ...
    public function run()
    {
        ...
        \DB::table('defendid_user')->insert(array (
            ...
            array (
                ...
                'username' => 'penilaikorporasi',
                'password' => Hash::make('penilaikorporasi'),
                'status_user' => 0,
                'is_risk_officer' => 0,
                'is_penilai' => 0,
                'is_penilai_korporasi' => 1,
